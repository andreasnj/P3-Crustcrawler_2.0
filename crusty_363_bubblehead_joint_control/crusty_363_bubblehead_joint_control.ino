...
void setup() {
  ...
  Dynamixel.setProfileAcceleration(0x04, 50);
...
while(z < 350 && z > 300 && jointexcess_prevention==0 && x > 0 && x < 1000 && y > 0 && y < 1000){                              //Tilting the head to the right moves on to the next joint && h prevents from excessive joint counting.
    joint++;
...
while(z > 600 && z < 650 && jointexcess_prevention==0 && x > 0 && x < 1000 && y > 0 && y < 1000){                              //Tilting the head to the left moves on to the previous joint
   joint--;
   jointexcess_prevention++;
   if(joint < 1){
    joint = 1;
...
while(joint == 1 && y > 650 && z > 400 && z < 600 && x > 0 && x < 1000){                        //Tilting forward moves joint 1 down
  i = i + 10;
  Dynamixel.setNGoalPositions(i, -1, -1, -1, -1);
  break;
}
while(joint == 1 && y < 450 && z > 400 && z < 600 && x > 0 && x < 1000){                        //Tilting backward moves joint 1 up
  i = i - 10;
  Dynamixel.setNGoalPositions(i, -1, -1, -1, -1);
  break;
}
while(joint == 2 && y > 650 && z > 400 && z < 600 && x > 0 && x < 1000){                        //Tilting forward moves joint 2 down
  j = j + 10;
  Dynamixel.setNGoalPositions(-1, j, -1, -1, -1);
  break;
}
while(joint == 2 && y < 450 && z > 400 && z < 600 && x > 0 && x < 1000){                        //Tilting backward moves joint 2 up
  j = j - 10;
  Dynamixel.setNGoalPositions(-1, j, -1, -1, -1);
  break;
}
while(joint == 3 && y > 650 && z > 400 && z < 600 && x > 0 && x < 1000){                        //Tilting forward moves joint 3 down
  k = k + 10;
  Dynamixel.setNGoalPositions(-1, -1, k, -1, -1);
  break;
}
while(joint == 3 && y < 450 && z > 400 && z < 600 && x > 0 && x < 1000){                        //Tilting backward moves joint 3 up
  k = k - 10;
  Dynamixel.setNGoalPositions(-1, -1, k, -1, -1);
  break;
}
while(joint == 4 && y > 650 && z > 400 && z < 600 && x > 0 && x < 1000){                        //Tilting forward opens the gripper
   Dynamixel.gripper(OPEN);
   break;
}
while(joint == 4 && y < 450 && z > 400 && z < 600 && x > 0 && x < 1000){                        //Tilting backward closes the gripper
   Dynamixel.gripper(CLOSE);
   break;
}

for(int a = 13; a < 24; a++) {
  z = infoPk[11] + (infoPk[10] << 8);
