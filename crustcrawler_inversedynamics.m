...
tf = 3;
theta01 = 1000 * 2*pi/4096; %in the graphs will be represented in radians, although input is in ticks of the motor
thetaf1 = 2000 * 2*pi/4096;
theta02 = 2000 * 2*pi/4096;
thetaf2 = 1000 * 2*pi/4096;
